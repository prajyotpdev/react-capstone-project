...
const Timer = ({ seconds, minutes, hours }) => {
      ...
      const interval = setInterval(() => {
        if (
          ...
          setRemainingTime((prevRemainingTime) => ({
            ...prevRemainingTime,
            seconds:
              prevRemainingTime.seconds === 0
                ? 59
                : prevRemainingTime.seconds - 1,
            minutes:
              prevRemainingTime.seconds === 0 && prevRemainingTime.minutes === 0
                ? 59
                : prevRemainingTime.minutes -
                  (prevRemainingTime.seconds === 0 ? 1 : 0),
            hours:
              prevRemainingTime.seconds === 0 && prevRemainingTime.minutes === 0
                ? prevRemainingTime.hours - 1
                : prevRemainingTime.hours,
          }));
  ...
  return (
    <div className="timercard">
      <div style={{ width: 200, height: 200 }} className="circularprogressbar" >
        <CircularProgressbar
          value={dashoffset}
          text={`${remainingTime.hours
            .toString()
            .padStart(1, "0")}:${remainingTime.minutes
            .toString()
      ...
      <div className="adjusttimer">
        <div className="timecomponent">
          <div className="timecomponentcolumn">
            Hours
              <img src={UpButton} onClick={handleHourIncrement} />
            {remainingTime.hours.toString().padStart(2, "0")}
              <img src={DecrementButton} onClick={handleHourDecrement} />
          </div>
          <div className="timecomponentcolumn">
            Minutes
              <img src={UpButton} onClick={handleMinuteIncrement}/>
           {remainingTime.minutes.toString().padStart(2, "0")}
              <img src={DecrementButton} onClick={handleMinuteDecrement} />
          </div>
          <div className="timecomponentcolumn">
            Seconds
              <img src={UpButton} onClick={handleSecondIncrement} />
            {remainingTime.seconds.toString().padStart(2, "0")}
              <img src={DecrementButton} onClick={handleSecondDecrement} />
          </div>
        </div>
        <button onClick={handleStartTimer} className="startbutton">
