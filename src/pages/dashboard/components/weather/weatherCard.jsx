...
var apiurl ="https://api.open-meteo.com/v1/forecast?latitude=79&longitude=21&current=temperature_2m,apparent_temperature,is_day,rain,pressure_msl,wind_speed_10m&timezone=GMT";

const { data, isLoading, error } = useQuery('users', async () => {
     const response = await axios.get('https://api.open-meteo.com/v1/forecast?latitude=79&longitude=21&current=temperature_2m,apparent_temperature,is_day,rain,pressure_msl,wind_speed_10m&timezone=GMT');
    ...
    <div className="weatherloghero">
     <div className="weatherlogchild">
          ...
          <div className="rainAttributes">
               {(weatherData.current.rain>10)?<div className="rainstatus">Heavy Rain</div>:<div className="rainstatus">No Rain</div>}
     ...
     <div className="weatherlogchild">
          ...
          {weatherData.current.temperature_2m??"Null"} °C
          </div>
          <div className="temperaturecomponent">            
